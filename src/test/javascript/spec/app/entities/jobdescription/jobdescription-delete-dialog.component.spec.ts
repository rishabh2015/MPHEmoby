...
import { JobdescriptionDeleteDialogComponent } from 'app/entities/jobdescription/jobdescription-delete-dialog.component';
  ...
  describe('Jobdescription Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [JobdescriptionDeleteDialogComponent],
      })
