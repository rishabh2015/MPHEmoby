...
describe('Service Tests', () => {
  describe('Projectphase Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ProjectphaseService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Projectphase(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Projectphase', () => {
        ...
        service.create(new Projectphase()).subscribe(resp => (expectedResult = resp.body));
