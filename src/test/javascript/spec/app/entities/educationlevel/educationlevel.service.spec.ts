...
describe('Service Tests', () => {
  describe('Educationlevel Service', () => {
    ...
    let elemDefault: IEducationlevel;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(EducationlevelService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Educationlevel(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Educationlevel', () => {
        ...
        service.create(new Educationlevel()).subscribe(resp => (expectedResult = resp.body));
