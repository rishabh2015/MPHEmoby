...
/**
 * REST controller for managing {@link com.emoby.mph.domain.Project}.
 */
@RestController
@RequestMapping("/api")
public class ProjectResource {
    ...
    @GetMapping("/projects/getFirstProjectByLoginId/{loginId}")
    public ResponseEntity<ProjectDTO> getFirstProjectByLoginId(@PathVariable Long loginId) throws URISyntaxException {
        log.debug("REST request to getFirstProjectByLoginId : {}", loginId);
        Optional<ProjectDTO> projectDTO = projectService.getFirstProjectByLoginId(loginId);
        return ResponseUtil.wrapOrNotFound(projectDTO);
