...
export class ContentService {
  ...
  public getCvByIdDocumentUrl = SERVER_API_URL + '/api/getCvByIdDocument?candidateId=';
  ...
  getCvByIdDocument(candiadteId?: number): Observable<EntityResponseType> {
    return this.http.get<IContent>(`${this.getCvByIdDocumentUrl}${candiadteId}`, { observe: 'response' });
  }
}
