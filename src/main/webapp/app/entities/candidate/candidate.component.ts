...
export class CandidateComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.candidateService
      ...
      .subscribe(
        (res: HttpResponse<ICandidate[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCandidates(): void {
    this.eventSubscriber = this.eventManager.subscribe('candidateListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICandidate[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
