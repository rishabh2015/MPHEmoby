...
export class JobdescriptionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.jobdescriptionService
      ...
      .subscribe(
        (res: HttpResponse<IJobdescription[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IJobdescription): number {
  ...
  protected onSuccess(data: IJobdescription[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
